...
class CvssInfo(object):
    ...
    def __init__(self, access_vector=None, base_score=None, temporal_score=None, local_vars_configuration=None):  # noqa: E501
        """CvssInfo - a model defined in OpenAPI"""  # noqa: E501
